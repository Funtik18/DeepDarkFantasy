...
namespace DDF.Editor {
	/// <summary>
	/// Расширяет способ отображения ссылок на объекты ScriptableObject в инспекторе.
	/// Показывает все значения в ссылке на объект. 
	/// Также имеется кнопка для создания нового ScriptableObject, если свойство имеет значение null.
	/// </summary>
	[CustomPropertyDrawer(typeof(ScriptableObject), true)]
	public class ExtendedScriptableObjectPropertyDrawer : PropertyDrawer {
